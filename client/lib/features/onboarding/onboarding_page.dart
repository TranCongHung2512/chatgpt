          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Our work to create safe and beneficial AI requires a deep understanding of the potential risks and benefits, as well as careful consideration of the inpact.",
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: AppColors.pinkBgColor),
